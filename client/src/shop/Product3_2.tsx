...
import aricat_nasiImg from "../assets/dress/3-2. aricat_nasi/catTshirt.png";
...
const PRODUCT_ID = "aricat_nasiTshirt";
...
const Product3_2 = () => {
  ...
  return (
    <div className="aricat_nasiTshirt_wrap">
      <div className="aricat_nasiTshirt_Header">
        <Header />  
      </div>    {/** aricat_nasiTshirt_Header end */}

      <div className="aricat_nasiTshirt_body">
        <div id="detail">
            ...
            <div className="prdimg">
              <div id="addimg" className="addimg">
                <div className="add_img">
                  <img src={aricat_nasiImg} alt="아리캣 민소매" />  
                </div>     {/** add_img end */}  

                <div className="detail_info">
                  <div className="img_wrapper" style={{ textAlign: "center" }}>
                    <img src={aricat_nasiDescImg} /> 
                  </div>      {/** img_wrapper end */}
      ...
      </div>      {/** aricat_nasiTshirt_body end */}

      <div className="aricat_nasiTshirt_Footer">
        <Footer />  
      </div>    {/** aricat_nasiTshirt_Footer end */}
    </div>      /** aricat_nasiTshirt_wrap end */
  );
};

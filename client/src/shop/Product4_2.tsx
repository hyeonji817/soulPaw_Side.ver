...
const PRODUCT_ID = "puppy_styptic";
...
const Product4_2 = () => {
  ...
  return (
    <div className="quickStop_wrap">
      <div className="quickStop_Header">
        <Header />  
      </div>    {/** quickStop_Header end */}

      <div className="quickStop_body">
        <div id="detail">
            ...
            <div className="prdimg">
              <div id="addimg" className="addimg">
                <div className="add_img">
                  <img src={quickStopImg} alt="체리폴라 티셔츠" />  
                </div>     {/** add_img end */}  

                <div className="detail_info">
                  <div className="img_wrapper" style={{ textAlign: "center" }}>
                    <img src={quickStopDescImg} /> 
                  </div>      {/** img_wrapper end */}
      ...
      </div>      {/** quickStop_body end */}

      <div className="quickStop_Footer">
        <Footer />  
      </div>    {/** quickStop_Footer end */}
    </div>      /** quickStop_wrap end */
  );
};

...
import geumhwadanHanbok from "../assets/dress/3-1. hanbok/hanbok.png";
...
const PRODUCT_ID = "geumhwadan-hanbok";
...
const Product3_1 = () => {
  ...
  return (
    <div className="geumhwadan_hanbok_wrap">
      <div className="geumhwadan_hanbok_Header">
        <Header />  
      </div>    {/** geumhwadan_hanbok_Header end */}

      <div className="geumhwadan_hanbok_body">
        <div id="detail">
            ...
            <div className="prdimg">
              <div id="addimg" className="addimg">
                <div className="add_img">
                  <img src={geumhwadanHanbok} alt="금화단 한복"/>  
                </div>     {/** add_img end */}  

                <div className="detail_info">
                  <div className="img_wrapper" style={{ textAlign: "center" }}>
                    <img src={hanbokDescImg} />
                  </div>      {/** img_wrapper end */}  
      ...
      </div>      {/** geumhwadan_hanbok_body end */}

      <div className="geumhwadan_hanbok_Footer">
        <Footer />  
      </div>    {/** geumhwadan_hanbok_Footer end */}
    </div>      /** geumhwadan_hanbok_wrap end */
  );
};

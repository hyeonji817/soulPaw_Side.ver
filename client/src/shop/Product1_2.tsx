...
const PRODUCT_ID = "iron-cat-pole";
...
const Product1_2 = () => {
  ...
  return (
    <div className="ironCatPole_wrap">
      <div className="ironCatPole_Header">
        <Header />  
      </div>      {/** ironCatPole_Header end */}

      <div className="ironCatPole_body">
        <div id="detail">
            ...
            <div className="prdimg">
              <div id="addimg" className="addimg">
                <div className="add_img">
                  <img src={ironCatPoleImg} alt="아이언 캣폴" />    
                </div>   {/** add_img end */}

                <div className="detail_info">
                  <div className="img_wrapper" style={{ textAlign: "center" }}>
                    <img src={ironCatPoleDescImg} />
                  </div>    {/** img_wrapper end */}
      ...
      </div>        {/** ironCatPole_body end */}

      <div className="ironCatPole_Footer">
        <Footer />  
      </div>      {/** ironCatPole_Footer end */}
    </div>      /** ironCatPole_wrap end */
  );
};

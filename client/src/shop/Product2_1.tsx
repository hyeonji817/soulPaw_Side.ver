...
const PRODUCT_ID = "dograng-classic";
...
const Product2_1 = () => {
  ...
  return (
    <div className="dograng_Classic_wrap">
      <div className="dograng_Classic_Header">
        <Header />  
      </div>    {/** dograng_Classic_Header end */}

      <div className="dograng_Classic_body">
        <div id="detail">
      ...
      </div>      {/** dograng_Classic_body end */}

      <div className="dograng_Classic_Footer">
        <Footer />  
      </div>    {/** dograng_Classic_Footer end */}
    </div>      /** dograng_Classic_wrap end */
  );
};

...
const Product2_2 = () => {
  ...
  return (
    <div className="mojjine_food_wrap">
      <div className="mojjine_food_Header">
        <Header />  
      </div>     {/** mojjine_food_Header end */}

      <div className="mojjine_food_body">
        <div id="detail">
            ...
            <div className="prdimg">
              <div id="addimg" className="addimg">
                <div className="add_img">
                  <img src={mojjineImg} alt="모찌네 전연령 사료" />  
                </div>   {/** add_img end */}

                <div className="detail_info">
                  <div className="img_wrapper" style={{ textAlign: "center" }}>
                    <img src={mojjineDescImg} />  
                  </div>  
      ...
      </div>       {/** mojjine_food_body end */}

      <div className="mojjine_food_Footer">
        <Footer />  
      </div>     {/** mojjine_food_Footer end */}
    </div>     /** mojjine_food_wrap end */
  );
};

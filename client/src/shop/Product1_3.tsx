...
const Product1_3 = () => {
  ...
  return (
    <div className="puppyStairs_wrap">
      <div className="puppyStairs_Header">
        <Header />  
      </div>      {/** puppyStairs_Header end */}

      <div className="puppyStairs_body">
        <div id="detail">
            ...
            <div className="prdimg">
              <div id="addimg" className="addimg">
                <div className="add_img">
                  <img src={puppyStairsImg} alt="펫 스텝!" />  
                </div>     {/** add_img end */}

                <div className="detail_info">
                  <div className="img_wrapper" style={{ textAlign: "center" }}>
                    <img src={puppyStairsDescImg} />  
                  </div>  
      ...
      </div>        {/** puppyStairs_body end */}

      <div className="puppyStairs_Footer">
        <Footer />  
      </div>      {/** puppyStairs_Footer end */}
    </div>      /** puppyStairs_wrap end */
  );
};

...
import petChurrImg from "../assets/food/2-3. rorench/3. petChurr1.png";
...
const PRODUCT_ID = "rorench-petchurr";

const product = {
  pname: "[지구샵Pick] 로렌츠 반려동물 츄르 (8개입)", 
  manufacturer: "로렌츠", 
  category: "사료간식", 
  public: "국산", 
  price: 8500, 
...
const Product2_3 = () => {
  ...
  return (
    <div className="rorench_petChurr_wrap">
      <div className="rorench_petChurr_Header">
        <Header />  
      </div>     {/** rorench_petChurr_Header end */}

      <div className="rorench_petChurr_body">
        <div id="detail">
            ...
            <div className="prdimg">
              <div id="addimg" className="addimg">
                <div className="add_img">
                  <img src={petChurrImg} alt="로렌츠 반려동물 츄르" />  
                </div>     {/** add_img end */}  
      ...
      </div>       {/** rorench_petChurr_body end */}

      <div className="rorench_petChurr_Footer">
        <Footer />
      </div>     {/** rorench_petChurr_Footer end */}
    </div>     /** rorench_petChurr_wrap end */
  );
};

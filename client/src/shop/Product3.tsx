...
const productPageClassBySlug: Record<string, string> = {
  "geumhwadan-hanbok": "geumhwadan_hanbok",
  "aricat-nasi-tshirt": "aricat_nasiTshirt",
  "cherry-pola-tshirt": "cherryPola_Tshirt",
};
...
const Product3 = ({ productSlug }: Product3Props) => {
  const nav = useNavigate();
  const classBase = productPageClassBySlug[productSlug] ?? "geumhwadan_hanbok";
